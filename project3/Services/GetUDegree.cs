...
{
    //The class that gets the data from the online api and converts it from json to c# for Undergraduate Degrees
    public class GetUDegrees
    {
        public async Task<List<Undergraduate>> getUDegrees()
        {
